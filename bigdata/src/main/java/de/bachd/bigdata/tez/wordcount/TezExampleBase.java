package de.bachd.bigdata.tez.wordcount;
...
public abstract class TezExampleBase extends Configured implements Tool {
	 ...
	 *
	 * @param conf
	 *            the tez configuration instance which will be used to crate the
	 *            DAG and possible the Tez Client.
	 * @param args
	 *            arguments to the example
	 * @param tezClient
	 *            an existing running {@link org.apache.tez.client.TezClient}
	 *            instance if one exists. If no TezClient is specified (null),
	 *            one will be created based on the provided configuration. If
	 *            TezClient is specified, local mode option can not been
	 ...
	 *            the dag to execute
	 * @param printCounters
	 *            whether to print counters or not
	 * @param logger
	 *            the logger to use while printing diagnostics
	 * @return Zero indicates success, non-zero indicates failure
	 * @throws TezException
	 ...
	 * @param tezConf
	 *            the tez configuration instance to be used while processing the
	 *            DAG
	 * @param tezClient
	 *            the tez client instance to use to run the DAG if any custom
	 *            monitoring is required. Otherwise the utility method
	 *            {@link #runDag(org.apache.tez.dag.api.DAG, boolean, org.slf4j.Logger)}
	 *            should be used
	 * @return Zero indicates success, non-zero indicates failure
	 * @throws IOException
	 * @throws TezException
